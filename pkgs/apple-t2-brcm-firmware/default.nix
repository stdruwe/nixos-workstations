# Temporary local copy of NixOS/nixos-hardware apple/t2 brcm-firmware.
# Based on upstream PR #1933 (head 48c8b5e0bd942604abf8034df9f43803fd31ffd7),
# which replaces the occasionally failing vmTools.runInLinuxVM extraction
# with userspace 7zz extraction. Remove this package once the upstream fix is merged
# and the pinned nixos-hardware revision contains it.
{
  lib,
  stdenvNoCC,
  callPackage,
